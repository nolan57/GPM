...
namespace GanttChartFramework.Views
{
    public partial class TaskBarControl : UserControl
    {
        ...
        private void DrawSampleTasks()
        {
            ...
            {
                new TaskItem { Id = 1, Name = "需求分析", StartDay = DateTime.Now, Duration = 5, ParentId = null, Color = Brushes.Blue, Progress = 100 },
                new TaskItem { Id = 2, Name = "设计开发", StartDay = DateTime.Now.AddDays(5), Duration = 10, ParentId = null, Color = Brushes.Green, Progress = 75 },
                new TaskItem { Id = 3, Name = "前端开发", StartDay = DateTime.Now.AddDays(5), Duration = 8, ParentId = 2, Color = Brushes.LightGreen, Progress = 90 },
                new TaskItem { Id = 4, Name = "后端开发", StartDay = DateTime.Now.AddDays(7), Duration = 9, ParentId = 2, Color = Brushes.DarkGreen, Progress = 60 },
                new TaskItem { Id = 5, Name = "测试验证", StartDay = DateTime.Now.AddDays(15), Duration = 5, ParentId = null, Color = Brushes.Orange, Progress = 20 },
                new TaskItem { Id = 6, Name = "部署上线", StartDay = DateTime.Now.AddDays(20), Duration = 3, ParentId = null, Color = Brushes.Purple, Progress = 0 }
            };
        ...
        {
            var childTasks = tasks.Where(t => t.ParentId.HasValue && t.ParentId.Value == parentId).ToList();
        ...
        private void DrawTaskBar(GanttChartFramework.Models.TaskItem task, double y, double indentation)
        {
            // 根据时间粒度计算任务条宽度
